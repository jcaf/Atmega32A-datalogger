...
//x = col
//y = row
void lcdan_set_cursor(int8_t col, int8_t row)
{
    ...
    if (row == 0)
        xy = LCDAN_BASEADDR_ROW_0 + col;
    else if (row == 1)
        xy = LCDAN_BASEADDR_ROW_1 + col;
    else if (row == 2)
        xy = LCDAN_BASEADDR_ROW_2 + col;
    else if (row == 3)
        xy = LCDAN_BASEADDR_ROW_3 + col;
