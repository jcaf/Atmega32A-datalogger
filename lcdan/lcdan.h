...
#define BKLIGHT_CONTRL
    ...
    #define PORTWxLCD_BKLIGHT PORTD
    #define PORTRxLCD_BKLIGHT PIND
    #define CONFIGIOxLCD_BKLIGHT DDRD
    #define PINxLCD_BKLIGHT 1

    #define lcdan_bklight_enable() do{PinTo1(PORTWxLCD_BKLIGHT, PINxLCD_BKLIGHT);}while(0)
    #define lcdan_bklight_disable() do{PinTo0(PORTWxLCD_BKLIGHT, PINxLCD_BKLIGHT);}while(0)
	//
	#define lcdan_bklight_on() do{PinTo1(PORTWxLCD_BKLIGHT, PINxLCD_BKLIGHT);}while(0)
    #define lcdan_bklight_off() do{PinTo0(PORTWxLCD_BKLIGHT, PINxLCD_BKLIGHT);}while(0)
