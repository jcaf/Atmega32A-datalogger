...
#define PINxLCDAN_RS 7

//RW->tied to ground
#define PORTWxLCDAN_RW PORTA
#define PORTRxLCDAN_RW PINA
#define CONFIGIOxLCDAN_RW DDRA
#define PINxLCDAN_RW 7

#define PORTWxLCDAN_E PORTA
#define PORTRxLCDAN_E PINA
#define CONFIGIOxLCDAN_E DDRA
#define PINxLCDAN_E 6
